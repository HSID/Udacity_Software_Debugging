...
def debug(command, my_locals):
    global stepping
    global breakpoints         #### breakpoints and watchpoints do not have to be explicitly declared as global
    global watchpoints         ####  since they are dictionaries which can be defaultly used as reference.
